...
# # Purana SQLite database (Backup ke liye comment kar diya)
# DATABASES = {
#     "default": {
...
# # Naya PostgreSQL Database
# DATABASES = {
#     'default': {
#         'ENGINE': 'django.db.backends.postgresql',
#         'NAME': 'wish2chat_db',       
#         'USER': 'postgres',           
#         'PASSWORD': 'Shreeji@123', # <--- DHYAN DEIN: Yahan apna pgAdmin wala asli password likhein
#         'HOST': 'localhost',          
#         'PORT': '5432',               
#     }
# }
...
DATABASES = {
    'default': {
        ...
        'PORT': '5432',
        'OPTIONS': {
            'connect_timeout': 60,  # 60 seconds tak wait karega
        }
    }
}
